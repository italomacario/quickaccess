...
@section('title', 'QuickAccess - '. $course->name)
@section('content')

<div class="container">
    <div class="row">

        <div id="body-row" class="col-lg-3">

            <div class="text-center">
                <img src="{{asset('storage/user/'.$course->user->image)}}" alt="" class="img-instructor rounded-circle mb-2">
                <h4>{{$course->user->name}}</h4>
            </div>

            <h5>{{$course->user->description}}</h5>
            ...
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <div class="text-center row">
                        <div class="col-lg-3">
                            <img src="{{asset('storage/course/'.$course->image)}}" alt="" class="img-instructor rounded-circle">
                        </div>
                        <div class="col-lg-9">
                            <h1>{{$course->name}}</h1>
                ...
                <div class="col-lg-12">
                    <iframe class="videopresentation" src="{{$course->video}}" allowfullscreen="allowfullscreen">
                    </iframe>
                </div>
            </div>
        </div>
